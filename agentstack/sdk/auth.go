...
func (s *AuthService) CreateAPIKey(ctx context.Context, req *APIKeyRequest) (*APIKey, error) {
	var apiKey APIKey
	if err := s.client.Post(ctx, "/api/v1/auth/api-keys", req, &apiKey); err != nil {
		return nil, err
	}
	return &apiKey, nil
}
...
func (s *AuthService) ListAPIKeys(ctx context.Context) (*ListAPIKeysResponse, error) {
	...
	if err := s.client.Get(ctx, "/api/v1/auth/api-keys", &response); err != nil {
		return nil, err
	}
	return &response, nil
}
...
func (s *AuthService) RevokeAPIKey(ctx context.Context, id string) error {
	return s.client.Delete(ctx, "/api/v1/auth/api-keys/"+id)
}
